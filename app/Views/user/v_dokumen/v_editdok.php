...
<div class="row">
    ...
    <form method="post" action="<?= base_url('user/dokumen/update'); ?>" enctype="multipart/form-data">
        <div class="col-md-2 mt-3">
            ...
            <input class="form-control" type="hidden" name="nama_dokumen" required value="<?= $data['nama_dokumen']; ?>"></input>
        ...
        <div class="col-md-6">
            <div>
                ...
                if (empty($_FILES['foto']['name'])) {
                    echo '<img id="fotobefore" src="' . base_url($data['file_dokumen']) . '" style="display:block; background-color: #ccc; max-width: 400px; max-height: 400px; margin:auto;" class="text-center mt-3" alt="' . $data['nama_dokumen'] . '" width="400">';
                }
                ?>
